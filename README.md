...
[![GoDoc](https://godoc.org/github.com/nerock/ozzo-validation?status.png)](http://godoc.org/github.com/nerock/ozzo-validation)
[![Build Status](https://travis-ci.org/nerock/ozzo-validation.svg?branch=master)](https://travis-ci.org/nerock/ozzo-validation)
[![Coverage Status](https://coveralls.io/repos/github/nerock/ozzo-validation/badge.svg?branch=master)](https://coveralls.io/github/nerock/ozzo-validation?branch=master)
[![Go Report](https://goreportcard.com/badge/github.com/nerock/ozzo-validation)](https://goreportcard.com/report/github.com/nerock/ozzo-validation)

## Description

This is a fork of [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) to return all validation errors found in every field instead just one error per field.
